...
class pvea {
  ...
  async mountLxcContainer(node, vmid) {
    console.log(colors.blue('Note: ') + 'Mounting LXC container ' + vmid + '.')
    return await this.post('/nodes/' + node + '/lxc/' + vmid + '/status/mount')
  }

  async unmountLxcContainer(node, vmid) {
    console.log(colors.blue('Note: ') + 'Unmounting LXC container ' + vmid + '.')
    return await this.post('/nodes/' + node + '/lxc/' + vmid + '/status/unmount')
  }
