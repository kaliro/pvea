...
class pvea {
  ...
  async getClusterStatus() {
    console.log(colors.blue('Note: ') + 'Getting cluster status...')
    var data

    const options = {
      method: 'GET',
      data: '',
      url: this.apiUrl + '/cluster/status',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'CSRFPreventionToken': this.csrfToken,
        'Cookie': this.ticket
  ...
  async getClusterBackupSchedule() {
    console.log(colors.blue('Note: ') + 'Getting cluster backup schedule...')
    var data

    const options = {
      method: 'GET',
      data: '',
      url: this.apiUrl + '/cluster/backup',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'CSRFPreventionToken': this.csrfToken,
        'Cookie': this.ticket
  ...
  async getNodeNetworks(node) {
    console.log(colors.blue('Note: ') + 'Getting node networks...')
    var data

    const options = {
      method: 'GET',
      data: '',
      url: this.apiUrl + '/nodes/' + node + '/network',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'CSRFPreventionToken': this.csrfToken,
        'Cookie': this.ticket
  ...
  async getNodeInterface(node, pmxInterface) {
    console.log(colors.blue('Note: ') + 'Getting node interface...')
    var data

    const options = {
      method: 'GET',
      data: '',
      url: this.apiUrl + '/nodes/' + node + '/network/' + pmxInterface,
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'CSRFPreventionToken': this.csrfToken,
        'Cookie': this.ticket
  ...
  async getNodeContainerIndex(node) {
    console.log(colors.blue('Note: ') + 'Getting container index...')
    var data

    const options = {
      method: 'GET',
      data: '',
      url: this.apiUrl + '/nodes/' + node + '/lxc/',
      headers: {
        'Content-Type': 'application/x-www-form-urlencoded',
        'CSRFPreventionToken': this.csrfToken,
        'Cookie': this.ticket
